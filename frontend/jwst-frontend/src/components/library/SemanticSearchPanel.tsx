...
/**
 * Semantic search over the local library (FAISS over FITS metadata).
 *
 * Was the standalone /search page until the MAST search took that slot
 * (#1618 fold-in); now rendered as the "Search library" tab of My Library.
 * Non-CE only — the semantic API never mounts in CE.
 */
