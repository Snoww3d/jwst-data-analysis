...
![Terminal output showing OOM crash when mosaicing mixed MIRI and NIRCam images, with explanation of the downscaling fix](../images/2026-02-12/image.png)

![GitHub PR list showing merged PRs for dark theme, composite channels, and multi-image support](../images/2026-02-12/image-2.png)

![GitHub diff stats showing +41 lines added and -666 lines removed](../images/2026-02-12/image-3.png)
